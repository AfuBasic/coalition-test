<x-layout title="Create New Task">
    <div class="flex justify-between items-center mb-5">
        ...
        <a href="{{ route('project.tasks.index', $project) }}" class="px-4 py-2 text-blue-500 hover:underline">Back</a>
    </div>
    <form action="{{ route('project.tasks.store', $project) }}" method="POST">
        ...
        <div class="mb-5">
            <x-select name="status" label="Status" :options="['todo' => 'ToDo', 'in_progress' => 'In Progress', 'completed' => 'Completed']" :selected="'todo'" />
        </div>
